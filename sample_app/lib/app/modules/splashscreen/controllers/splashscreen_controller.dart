...
class SplashscreenController extends GetxController {
  void initAds() {
    ...
    if (Platform.isAndroid) serverManager.setApiKey("DA8BB129F7C1ED5BD07046961C995A77");
    if (Platform.isIOS) serverManager.setApiKey("f9ab6889e85f61d7ef988a6b1e57fcd4");

    serverManager.setPackageName("com.ugikpoenya.sampleapp");
